...
- [ ] Phase 1: Type System Foundation - Add group interfaces and schema updates
- [ ] Phase 2: Core Logic - Loader expansion, sanitizer, validator
- [ ] Phase 3: Extraction Support - Compression from tiles to groups
