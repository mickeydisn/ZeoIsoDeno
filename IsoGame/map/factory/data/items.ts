...
export const GAME_FLORE_ITEMS_OLD = [
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 0, min: 0, max: 255 },
    cFilter: "H75",
    key: "tree_detailed_dark",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 1, min: 0, max: 255 },
    cFilter: "H90",
    key: "tree_blocks",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 2, min: 0, max: 255 },
    cFilter: "H115",
    key: "tree_detailed_dark",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 3, min: 0, max: 255 },
    cFilter: "H120",
    key: "tree_blocks",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 4, min: 0, max: 255 },
    cFilter: "H45",
    key: "tree_oak_dark",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 5, min: 0, max: 255 },
    cFilter: "H30",
    key: "tree_oak_dark",
  },
  {
    b: B_ALL,
    l: { min: 0, max: 255 },
    flore: { mod: 32, eq: 6, min: 0, max: 255 },
    cFilter: "H75",
    key: "tree_blocks",
  },
].map((x) => {
...
*/
export type GameFloreItem = {
  b: number[]; // Assuming B_ALL is a string constant or type
  l: { min: number; max: number }; // l is an object with 'min' and 'max' as numbers
  flore: { mod: number; eq: number; min: number; max: number }; // flore is an object with mod, eq, min, and max as numbers
  cFilter: string; // cFilter is a string
  key: string; // key is a string
};

export const GAME_FLORE_ITEMS: GameFloreItem[] = [
  // ---------------------------------------
  // Ice Desert (-10)
  // ---------------------------------------
  ...[
