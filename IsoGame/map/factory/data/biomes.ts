...
export const GAME_BIOMES_MATRIS: string[] = [
  "-9",
  "-9",
  "-9",
  "-7",
...
export type GameBiomesType = {
  id: string; // The id is a string
  name: string; // The name is a string
  lvlType: string; // The lvlType is a string
  rgb: string[]; // The rgb is an array of strings
};

export const GAME_BIOMES: GameBiomesType[] = [
  {
    id: "10",
    name: "Volcanic",
    lvlType: "Hill",
