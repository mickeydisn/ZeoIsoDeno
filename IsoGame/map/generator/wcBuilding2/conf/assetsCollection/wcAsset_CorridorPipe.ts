...
export class WcAsset_CorridorPipe {
  ...
  get Door2(): WcConfTile {
    return {
      ...
      weight: 0,
      assets: [
        { h: .2, key: "pipe_end", keyR: 2, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  // ["A", "Wout", "WoutD", "Wout"],
  get Door(): WcConfTile {
    return {
      ...
      weight: 0,
      assets: [
        { h: .2, key: "pipe_entrance", keyR: 2, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  ...
  get Flat(): WcConfTile {
    return {
      ...
      assets: [
        ...
        { h: .2, key: "pipe_straight", keyR: 0, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  ...
  get Flat_Open(): WcConfTile {
    return {
      ...
      weight: 0,
      assets: [
        { h: .2, key: "pipe_open", keyR: 0, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  ...
  get Flat_Ring(): WcConfTile {
    return {
      ...
      assets: [
        { h: 0, key: "pipe_supportLow", keyR: 0, sufix: this.WALL_SUFFIX },
        { h: .2, key: "pipe_ring", keyR: 0, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  ...
  get Corner(): WcConfTile {
    return {
      ...
      weight: 0,
      assets: [
        { h: .2, key: "pipe_corner", keyR: 3, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  //["A", "A", "Wout", "Wout"],
  get Corner_Round(): WcConfTile {
    return {
      ...
      weight: 0,
      assets: [
        { h: .2, key: "pipe_cornerRound", keyR: 3, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  // pipe_cornerDiagonal
  ...
  get TJoin(): WcConfTile {
    return {
      ...
      assets: [
        { h: 0, key: "pipe_supportLow", keyR: 0, sufix: this.WALL_SUFFIX },
        { h: .2, key: "pipe_split", keyR: 3, sufix: this.WALL_SUFFIX },
      ],
    };
  }
  // ["A", "A", "A", "A"]
  get CrossJoin(): WcConfTile {
    return {
      ...
      assets: [
        { h: 0, key: "pipe_supportLow", keyR: 0, sufix: this.WALL_SUFFIX },
        { h: .2, key: "pipe_cross", keyR: 0, sufix: this.WALL_SUFFIX },
      ],
    };
  }
