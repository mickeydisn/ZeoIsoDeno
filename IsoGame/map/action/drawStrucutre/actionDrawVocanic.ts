...
export function actionDrawVolcanicCrater(
  ...
  b.push(
    cmd.colorSquare      ({ x, y, size: 26, shape: "circle", color: C.ROCK }),
  );
  ...
  b.push(
    cmd.colorSquare      ({ x, y, size: 18, shape: "circle", color: C.DARK_BASALT }),
  ...
  b.push(
    // cmd.lvlUpSquare      ({ x, y, size: 12, lvl: baseLvl + 1 }),
    cmd.colorSquare      ({ x, y, size: 12, shape: "circle", color: C.SCORCHED }),
    cmd.colorNoiseShape  ({ x, y, size: 12, shape: "circle", color: C.SCORCHED, noiseAmp: 12 }),
  );

  // ── 6. Crater pit — sunken flat floor, deep red lava
  b.push(
    // cmd.lvlUpSquare      ({ x, y, size: 6, lvl: baseLvl + 1 }),
    cmd.colorSquare      ({ x, y, size: 6, shape: "circle", color: C.LAVA_DEEP }),
  ...
  b.push(
    ...
    cmd.colorSquare      ({ x, y, size: 2, shape: "circle",  color: C.LAVA_BRIGHT }),
  ...
  // Raise rim to peak
  b.push(
    cmd.lvlUpSquare      ({ x, y, size: 26, shape: "circle", lvl: -12 }),
    cmd.lvlUpSquare      ({ x, y, size: 18, shape: "circle", lvl: -12 }),
    cmd.lvlUpSquare      ({ x, y, size: 12, shape: "circle", lvl: -12 }),
    cmd.lvlUpSquare      ({ x, y, size: 6, shape: "circle", lvl: -12 }),
    cmd.lvlUpSquare      ({ x, y, size: 2, shape: "circle", lvl: -12 }),
  );

  b.push(
    cmd.lvlAvgSquare  ({ x, y, size: 80}),
  );
