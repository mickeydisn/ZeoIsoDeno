...
export const _drawTileFloor = (
  ...
  if (diffLvlSE > 0 && _ctx.conf.mapGridTileScale > .5) {
    _ctx.isomer.add(
      Shape.SurfaceSE(
  ...
  if (diffLvlSW > 0 && _ctx.conf.mapGridTileScale > .4) {
    _ctx.isomer.add(
      Shape.SurfaceSW(
...
export const _drawTileFront = (
  ...
  _ctx.isomer.add(
    Shape.SurfaceFlat(
      new Point(p.x + p.xoff, p.y + p.yoff, currentlvl - height),
      1 - p.xoff,
      1 - p.yoff,
      height,
    ),
  ...
  if (diffLvlSE > 0 && _ctx.conf.mapGridTileScale > .5) {
    _ctx.isomer.add(
      Shape.SurfaceSE(
        new Point(p.x + p.xoff, p.y + p.yoff, currentlvl - diffLvlSE),
        1 - p.xoff,
        1 - p.yoff,
        diffLvlSE,
      ),
  ...
  if (diffLvlSW > 0 && _ctx.conf.mapGridTileScale > .4) {
    _ctx.isomer.add(
      Shape.SurfaceSW(
        new Point(p.x + p.xoff, p.y + p.yoff, currentlvl - diffLvlSW),
        1 - p.xoff,
        1 - p.yoff,
        diffLvlSW,
      ),
...
export const _drawTileBack = (
  ...
  _ctx.isomer.add(
    Shape.SurfaceFlat(
      new Point(p.x, p.y, currentlvl - height),
      1 - p.xoff,
      1 - p.yoff,
      height,
    ),
  ...
  if (diffLvlSE > 0 && _ctx.conf.mapGridTileScale > .5) {
    _ctx.isomer.add(
      Shape.SurfaceSE(
        new Point(p.x, p.y, currentlvl - diffLvlSE),
        1 - p.xoff,
        1 - p.yoff,
        diffLvlSE,
      ),
  ...
  if (diffLvlSW > 0 && _ctx.conf.mapGridTileScale > .4) {
    _ctx.isomer.add(
      Shape.SurfaceSW(
        new Point(p.x, p.y, currentlvl - diffLvlSW),
        1 - p.xoff,
        1 - p.yoff,
        diffLvlSW,
      ),
