...
import { indexRenderHandler, RenderMessageHandler } from "@iso-game/handlers/handlers.ts";
import { CANVAS_HEIGHT, CANVAS_WIDTH, gobalMapState } from "@iso-game/mapIso/mapState.ts";
import { CanvasMapDrawersConf, CanvasMapDrawersConfDefault } from "@iso-game/mapIso/render/type.ts";
...
export const  createHander = (
    ...
    const offScreenCanvas = canvas ? canvas : _createCanvas(CANVAS_WIDTH, CANVAS_HEIGHT);
