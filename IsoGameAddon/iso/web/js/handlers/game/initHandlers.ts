...
const initWorker : TGameHandlerAction<EventInitWorker> = 
  gameAction<EventInitWorker>("initWorker", 
   async (_data: EventInitWorker, _ctx: TGameHandlerContext) => {
...
const setOffScreenCanvas : TGameHandlerAction<EventSetCanvasMap> = 
  gameAction<EventSetCanvasMap>("setOffScreenCanvas", 
...
const initCanvasMap : TGameHandlerAction<EventInitCanvasMap> = 
  gameAction<EventInitCanvasMap>("initCanvasMap", 
   (data: EventInitCanvasMap, _ctx: TGameHandlerContext) => {
  ...
  mapState._isoProject = _ctx.gameloop.canvasMapDrawer.isoProject
